...
class AppBody(ft.UserControl):
    def __init__(self, page:ft.Page,assignments:list,header:AppHeader):
        ...
        for _ in range(len(assignments)): self.lv.controls.append(ft.TextButton(text=assignments[_][1],on_click=self.assignment_clicked,data=[assignments[_][1],assignments[_][3]]))
